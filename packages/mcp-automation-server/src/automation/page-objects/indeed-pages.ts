...
export class IndeedLoginPage {
  ...
  constructor(page: Page) {
    ...
    this.emailInput = page.locator(
      '#ifl-InputFormField-3, input[type="email"]',
    );
    this.passwordInput = page.locator(
      '#ifl-InputFormField-15, input[type="password"]',
    );
...
export class IndeedJobPage {
  ...
  constructor(page: Page) {
    ...
    this.applyNowButton = page.locator(
      "#indeedApplyButton, .indeed-apply-button",
    );
    this.jobTitleHeader = page.locator(
      ".jobsearch-JobInfoHeader-title-container h1",
    );
    this.companyNameHeader = page.locator(
      '[data-company-name="true"], .jobsearch-CompanyInfoWithoutHeaderImage a',
    );
  }
