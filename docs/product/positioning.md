...
- **AKCP (Agent Knowledge Compiler and Control Plane)**: Compiles, validates, optimizes, governs, and distributes knowledge artifacts. It bridges the gap between raw unstructured knowledge and agent-ready context packs.
